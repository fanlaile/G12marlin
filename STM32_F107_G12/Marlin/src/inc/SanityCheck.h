 ...
 */
    ...
    + ENABLED(SPI_FLASH_EEPROM_EMULATION) \
...
#if ENABLED(USB_FLASH_DRIVE_SUPPORT) && ENABLED(USB_DISK_SUPPORT)
  #error "Please enable only one of USB_FLASH_DRIVE_SUPPORT and USB_DISK_SUPPORT."
#endif
