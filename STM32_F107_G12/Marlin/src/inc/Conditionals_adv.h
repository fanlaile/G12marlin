 ...
 */
  ...
  #else
    #define MINIMUM_STEPPER_POST_DIR_DELAY 50000   // Expect at least 10µS since one Stepper ISR must transpire
  #endif
#endif
...
#if ENABLED(EEPROM_SETTINGS) && NONE(I2C_EEPROM, SPI_EEPROM, QSPI_EEPROM, FLASH_EEPROM_EMULATION, SPI_FLASH_EEPROM_EMULATION, SRAM_EEPROM_EMULATION, SDCARD_EEPROM_EMULATION)
