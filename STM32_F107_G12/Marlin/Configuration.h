...
//50W加热棒：Kp 14.63  Ki 0.98  Kd 54.53
    ...
    #define DEFAULT_Kp_LIST {  23.16,  12.63 }
    #define DEFAULT_Ki_LIST {   0.47,   0.19 }
    #define DEFAULT_Kd_LIST { 284.86, 208.72 }
  #else
    #define DEFAULT_Kp  16.55 // 26.58
    #define DEFAULT_Ki   0.16  // 2.57
    #define DEFAULT_Kd  428.60 // 68.70
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current // 最大电流输出阈值; 255=全功率输出
  ...
  #define DEFAULT_bedKp 125.72 // 182.30
  #define DEFAULT_bedKi  19.64 // 35.54
  #define DEFAULT_bedKd 536.42 // 623.41
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 101.05, 106.67, 853, 13 } // 34, 
...
#define INVERT_E0_DIR false   // 伺服电机方向相反
